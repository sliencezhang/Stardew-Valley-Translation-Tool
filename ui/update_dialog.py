...
from ui.styles import get_dialog_style, get_roll_button_style
from ui.widgets import BackgroundWidget, load_background_image


class UpdateDialog(QDialog):
    """星露谷物语翻译工具 - 自定义更新通知对话框"""
    ...
    def init_ui(self):
        ...
        # 应用按钮样式
        self.cancel_btn.setStyleSheet(get_roll_button_style(config.theme))
        self.confirm_btn.setStyleSheet(get_roll_button_style(config.theme))
